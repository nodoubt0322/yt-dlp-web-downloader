...
- [ ] Confirm system status shows `yt-dlp`, `ffmpeg`, `ffprobe`, storage writable state, and disk space.
...
- [ ] Start the default download and confirm the app routes to `/jobs/{jobId}`.
